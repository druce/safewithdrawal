...
ggplot(data=plotframe, aes(x=worst, y=ce4, colour=frontier, shape=frontier)) +
    ...
    labs(title="Lifetime CE spending (gamma=4) vs. shortfall, selected percentiles", size=16) +
