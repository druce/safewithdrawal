...
ggplot(data=plotframe, aes(x=prob, y=ce8, colour=frontier, shape=frontier)) +
    scale_x_continuous() +
    ylab("Lifetime CE spending, gamma=8") +
    ...
    labs(title="Lifetime CE spending (gamma=8) vs. selected shortfall probabilities", size=16) +
