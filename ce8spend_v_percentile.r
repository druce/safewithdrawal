...
ggplot(data=plotframe, aes(x=worst, y=ce8, colour=frontier, shape=frontier)) +
    scale_x_continuous() +
    ...
    labs(title="Lifetime CE spending (gamma=8) vs. shortfall, selected percentiles", size=16) +
