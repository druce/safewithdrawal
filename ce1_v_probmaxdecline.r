...
ggplot(data=plotframe, aes(x=prob, y=ce1, colour=frontier, shape=frontier)) +
    scale_x_continuous() +
...
ggplot(data=plotframe0, aes(x=prob, y=ce1, colour=frontier, shape=frontier)) +
    scale_x_continuous() +
    ylab("Lifetime spending") +
    xlab("Shortfall prob %") +
    theme_bw() +
